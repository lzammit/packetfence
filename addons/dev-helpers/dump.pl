...
dump.pl <config|doc_config|floatingdevices|profiles_filters|profiles|sources|switch <id>|switches|admin_roles|chiconfig|vlanfilters>
...
sub _run {
    require pf::config;
    print Data::Dumper::Dumper(\%pf::config::ConfigVlanFilters);
}
